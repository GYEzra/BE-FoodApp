...
routerAPI.get('/logout', checkUserJWT, logout)
routerAPI.post('/users', resgiter)

routerAPI.get('/users', getAllUser)
routerAPI.put('/users', checkUserJWT, updateUser)
routerAPI.get('/users/:id', checkUserJWT, getUser)
...
routerAPI.get('/orders', checkUserJWT, getAllOrder)
routerAPI.get('/orders/:id', checkUserJWT, getOrder)
routerAPI.post('/orders', checkUserJWT, createOrder)
routerAPI.put('/orders', checkUserJWT, updateOrder)
routerAPI.delete('/orders', checkUserJWT, deleteOrder)
